...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('vacantes', function (Blueprint $table) {
            ...
            //
            $table->string('titulo');
            #Si queremos que laravel nos detecte los campos debemos de correctamente aqui el campo de la relacion debe de ser en singulkar y en la tabla debe de ser prulal
    ...
    {
        Schema::table('vacantes', function (Blueprint $table) {
            #Siu no declaramos que se eliminen la llaves foraneas al hacer un rollback no nos va permitir eliminar las tablas asi que lo debemos de declarar 

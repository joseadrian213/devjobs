<form action="" class="md:w-1/2 space-y-5" wire:submit.prevent='editarVacante'>
    ...
    <div>
        ...
        <div class="my-5 w-96">
            ...
            {{-- Las imagenes solo se pueden acceder a traves de la carpeta ia carpeta public 
            Como en este caso se encuentran en storage se debe de crear un link simbolico para darle a permiso al usuario de que pueda solo acceder a esas imagenes  --}}
            <img src="{{ asset('storage/vacantes/' . $imagen) }}" alt="{{ 'Imagen Vacantes' . $titulo }}">
